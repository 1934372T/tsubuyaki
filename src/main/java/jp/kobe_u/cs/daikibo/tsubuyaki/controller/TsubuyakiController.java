...
public class TsubuyakiController {
    ...
    String postTsubuyaki(@ModelAttribute("tsubuyakiForm") TsubuyakiForm form, Model model) {
     ...
     //つぶやきを表示
     @GetMapping("/search")
     public String searchTsubuyaki(@ModelAttribute("tsubuyakiForm") TsubuyakiForm tsubuyakiForm, Model model) {
        String keyword = tsubuyakiForm.getKeyword();

        // キーワードを使ってコメントを検索する処理を実装したTsubuyakiServiceを使う
        List<Tsubuyaki> searchResults = ts.searchTsubuyakiByKeyword(keyword);
